...
const Hobby = () => {
  return (
    <div className="absolute top-[750vh] left-0 sm:left-[60vw] w-screen sm:w-[35vw] px-12 py-48 pb-80 space-y-12 backdrop-blur-md sm:bg-transparent bg-opacity-90 rounded-3xl">
